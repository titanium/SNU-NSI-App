...
/**
 The base class for all NSI2012 modules
 */
...
/**
 NSI2012 Platform calls this method on startup.
 */
-(void)startup;

/**
 NSI2012 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 NSI2012 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 NSI2012 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 NSI2012 Platform calls this method on resume.
 @param sender The sender of the event.
 */
