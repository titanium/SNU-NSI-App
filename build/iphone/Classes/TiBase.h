...
// in simulator we redefine to format for NSI2012 Developer console
...
{\
	NSString * exceptionName = [@"org.nsi2012." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.nsi2012";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UINSI2012NativeItemNone = -1, 
	UINSI2012NativeItemSpinner = -2,
	UINSI2012NativeItemProgressBar = -3,
	
	UINSI2012NativeItemSlider = -4,
	UINSI2012NativeItemSwitch = -5,
	UINSI2012NativeItemMultiButton = -6,
	UINSI2012NativeItemSegmented = -7,
	
	UINSI2012NativeItemTextView = -8,
	UINSI2012NativeItemTextField = -9,
	UINSI2012NativeItemSearchBar = -10,
	
	UINSI2012NativeItemPicker = -11,
	UINSI2012NativeItemDatePicker = -12,
	
	UINSI2012NativeItemInfoLight = -13,
	UINSI2012NativeItemInfoDark = -14,
	
	UINSI2012NativeItemDisclosure = -15,
	
	UINSI2012NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all NSI2012 instances of
