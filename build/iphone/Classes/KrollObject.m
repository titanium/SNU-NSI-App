 ...
 * Copyright (c) 2009-2012 by NSI2012, Inc. All Rights Reserved.
...
//@interface NSI2012Object : NSObject
//@end

@interface NSI2012Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[NSI2012Object class]])
		{
			for (NSString *key in [[(NSI2012Object*)o modules] allKeys])
			{
