...
//Rare exceptions to indicate a bug in the _nsi2012 code (Eg, method that a subclass should have implemented)
...
+ (id)createProxy:(NSString*)qualifiedName withProperties:(NSDictionary*)properties inContext:(id<TiEvaluator>)context
{
	...
	if (proxyClass == nil) {
		NSString *_nsi2012 = [NSString stringWithFormat:@"%@%s",@"Ti","tanium."];
		if ([qualifiedName hasPrefix:_nsi2012]) {
		...
		if (proxyClass==nil) {
			...
			@throw [NSException exceptionWithName:@"org.nsi2012.module"
