...
if (!isAndroid) {
	gazeboParams.pincolor = Titanium.Map.ANNOTATION_PURPLE;
} else {
	gazeboParams.pinImage = "../images/map-pin.png";
}
var gazebo = Titanium.Map.createAnnotation(gazeboParams);

//
// PRE-DEFINED REGIONS
//
var regionGazebo = {latitude:35.513998,longitude:-97.628388,animate:true,latitudeDelta:0.04, longitudeDelta:0.04};
...
var presetAnnotations = [gazebo];
var mapview = Titanium.Map.createView({
	mapType: Titanium.Map.HYBRID_TYPE,
	region:{latitude:35.513998, longitude:-97.628388, latitudeDelta:0.0009, longitudeDelta:0.0009}, 
	animate:true,
	regionFit:true,
	userLocation:true,
...
if (!isAndroid) {
	mapview.addAnnotation(gazebo);
}
mapview.selectAnnotation(gazebo);
win.add(mapview);
...
gazebo.addEventListener('click', function(evt)
{
