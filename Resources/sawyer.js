...
if (!isAndroid) {
	sawyerParams.pincolor = Titanium.Map.ANNOTATION_PURPLE;
} else {
	sawyerParams.pinImage = "../images/map-pin.png";
}
var sawyer = Titanium.Map.createAnnotation(sawyerParams);

//
// PRE-DEFINED REGIONS
//
var regionSawyer = {latitude:35.512062,longitude:-97.625992,animate:true,latitudeDelta:0.04, longitudeDelta:0.04};
...
var presetAnnotations = [sawyer];
var mapview = Titanium.Map.createView({
	mapType: Titanium.Map.HYBRID_TYPE,
	region:{latitude:35.512062, longitude:-97.625992, latitudeDelta:0.0009, longitudeDelta:0.0009}, 
	animate:true,
	regionFit:true,
	userLocation:true,
...
if (!isAndroid) {
	mapview.addAnnotation(sawyer);
}
mapview.selectAnnotation(sawyer);
win.add(mapview);
...
sawyer.addEventListener('click', function(evt)
{
