...
if (!isAndroid) {
	herrickParams.pincolor = Titanium.Map.ANNOTATION_PURPLE;
} else {
	herrickParams.pinImage = "../images/map-pin.png";
}
var herrick = Titanium.Map.createAnnotation(herrickParams);

//
// PRE-DEFINED REGIONS
//
var regionHerrick = {latitude:35.512473,longitude:-97.630455,animate:true,latitudeDelta:0.04, longitudeDelta:0.04};
...
var presetAnnotations = [herrick];
var mapview = Titanium.Map.createView({
	mapType: Titanium.Map.HYBRID_TYPE,
	region:{latitude:35.512473, longitude:-97.630455, latitudeDelta:0.0009, longitudeDelta:0.0009}, 
	animate:true,
	regionFit:true,
	userLocation:true,
...
if (!isAndroid) {
	mapview.addAnnotation(herrick);
}
mapview.selectAnnotation(herrick);
win.add(mapview);
...
herrick.addEventListener('click', function(evt)
{
