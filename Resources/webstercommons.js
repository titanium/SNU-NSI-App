...
var webstercommonsParams = {
		latitude:35.514403, 
		longitude:-97.628798,
		title:"SNU",
		subtitle:'Webster Commons',
		animate:true,
...
if (!isAndroid) {
	webstercommonsParams.pincolor = Titanium.Map.ANNOTATION_PURPLE;
} else {
	webstercommonsParams.pinImage = "../images/map-pin.png";
}
var webstercommons = Titanium.Map.createAnnotation(webstercommonsParams);

//
// PRE-DEFINED REGIONS
//
var regionWebstercommons = {latitude:35.514403,longitude:-97.628798,animate:true,latitudeDelta:0.04, longitudeDelta:0.04};
...
var presetAnnotations = [webstercommons];
var mapview = Titanium.Map.createView({
	mapType: Titanium.Map.HYBRID_TYPE,
	region:{latitude:35.514403, longitude:-97.628798, latitudeDelta:0.0009, longitudeDelta:0.0009}, 
	animate:true,
	regionFit:true,
	userLocation:true,
...
if (!isAndroid) {
	mapview.addAnnotation(webstercommons);
}
mapview.selectAnnotation(webstercommons);
win.add(mapview);
...
webstercommons.addEventListener('click', function(evt)
{
