...
if (!isAndroid) {
	brackenParams.pincolor = Titanium.Map.ANNOTATION_PURPLE;
} else {
	brackenParams.pinImage = "../images/map-pin.png";
}
var bracken = Titanium.Map.createAnnotation(brackenParams);

//
// PRE-DEFINED REGIONS
//
var regionBracken = {latitude:35.513624,longitude:-97.630536,animate:true,latitudeDelta:0.04, longitudeDelta:0.04};
...
var presetAnnotations = [bracken];
var mapview = Titanium.Map.createView({
	mapType: Titanium.Map.HYBRID_TYPE,
	region:{latitude:35.513624, longitude:-97.630536, latitudeDelta:0.0009, longitudeDelta:0.0009}, 
	animate:true,
	regionFit:true,
	userLocation:true,
...
if (!isAndroid) {
	mapview.addAnnotation(bracken);
}
mapview.selectAnnotation(bracken);
win.add(mapview);
...
bracken.addEventListener('click', function(evt)
{
