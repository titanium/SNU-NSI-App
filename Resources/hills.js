...
var hillsParams = {
		...
		longitude:-97.627138,
		title:"SNU",
		subtitle:'A.M. Hills Residential Complex',
		animate:true,
...
if (!isAndroid) {
	hillsParams.pincolor = Titanium.Map.ANNOTATION_PURPLE;
} else {
	hillsParams.pinImage = "../images/map-pin.png";
}
var hills = Titanium.Map.createAnnotation(hillsParams);

//
// PRE-DEFINED REGIONS
//
var regionHills = {latitude:35.512369,longitude:-97.627138,animate:true,latitudeDelta:0.04, longitudeDelta:0.04};
...
if (!isAndroid) {
	mapview.addAnnotation(hills);
}
mapview.selectAnnotation(hills);
win.add(mapview);
...
hills.addEventListener('click', function(evt)
{
