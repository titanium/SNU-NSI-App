...
if (!isAndroid) {
	asburyParams.pincolor = Titanium.Map.ANNOTATION_PURPLE;
} else {
	asburyParams.pinImage = "../images/map-pin.png";
}
var asbury = Titanium.Map.createAnnotation(asburyParams);

//
// PRE-DEFINED REGIONS
//
var regionAsbury = {latitude:35.512192,longitude:-97.630866,animate:true,latitudeDelta:0.04, longitudeDelta:0.04};
...
var presetAnnotations = [asbury];
var mapview = Titanium.Map.createView({
	mapType: Titanium.Map.HYBRID_TYPE,
	region:{latitude:35.512192, longitude:-97.630866, latitudeDelta:0.0009, longitudeDelta:0.0009}, 
	animate:true,
	regionFit:true,
	userLocation:true,
...
if (!isAndroid) {
	mapview.addAnnotation(asbury);
}
mapview.selectAnnotation(asbury);
win.add(mapview);
...
asbury.addEventListener('click', function(evt)
{
