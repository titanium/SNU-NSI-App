...
var fineartslawnParams = {
		latitude:35.514251, 
		longitude:-97.629356,
		title:"SNU",
		subtitle:'Fine Arts Building Lawn',
		animate:true,
...
if (!isAndroid) {
	fineartslawnParams.pincolor = Titanium.Map.ANNOTATION_PURPLE;
} else {
	fineartslawnParams.pinImage = "../images/map-pin.png";
}
var fineartslawn = Titanium.Map.createAnnotation(fineartslawnParams);

//
// PRE-DEFINED REGIONS
//
var regionFineartslawn = {latitude:35.514251,longitude:-97.629356,animate:true,latitudeDelta:0.04, longitudeDelta:0.04};
...
var presetAnnotations = [fineartslawn];
var mapview = Titanium.Map.createView({
	mapType: Titanium.Map.HYBRID_TYPE,
	region:{latitude:35.514251, longitude:-97.629356, latitudeDelta:0.0009, longitudeDelta:0.0009}, 
	animate:true,
	regionFit:true,
	userLocation:true,
...
if (!isAndroid) {
	mapview.addAnnotation(fineartslawn);
}
mapview.selectAnnotation(fineartslawn);
win.add(mapview);
...
fineartslawn.addEventListener('click', function(evt)
{
