...
var lampoflearningParams = {
		latitude:35.513457, 
		longitude:-97.629989,
		title:"SNU",
		subtitle:'Lamp of Learning',
		animate:true,
...
if (!isAndroid) {
	lampoflearningParams.pincolor = Titanium.Map.ANNOTATION_PURPLE;
} else {
	lampoflearningParams.pinImage = "../images/map-pin.png";
}
var lampoflearning = Titanium.Map.createAnnotation(lampoflearningParams);

//
// PRE-DEFINED REGIONS
//
var regionLampoflearning = {latitude:35.513457,longitude:-97.629989,animate:true,latitudeDelta:0.04, longitudeDelta:0.04};
...
var presetAnnotations = [lampoflearning];
var mapview = Titanium.Map.createView({
	mapType: Titanium.Map.HYBRID_TYPE,
	region:{latitude:35.513457, longitude:-97.629989, latitudeDelta:0.0009, longitudeDelta:0.0009}, 
	animate:true,
	regionFit:true,
	userLocation:true,
...
if (!isAndroid) {
	mapview.addAnnotation(lampoflearning);
}
mapview.selectAnnotation(lampoflearning);
win.add(mapview);
...
lampoflearning.addEventListener('click', function(evt)
{
