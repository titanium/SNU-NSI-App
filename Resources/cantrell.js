...
if (!isAndroid) {
	cantrellParams.pincolor = Titanium.Map.ANNOTATION_PURPLE;
} else {
	cantrellParams.pinImage = "../images/map-pin.png";
}
var cantrell = Titanium.Map.createAnnotation(cantrellParams);

//
// PRE-DEFINED REGIONS
//
var regionCantrell = {latitude:35.512902,longitude:-97.629424,animate:true,latitudeDelta:0.04, longitudeDelta:0.04};
...
var presetAnnotations = [cantrell];
var mapview = Titanium.Map.createView({
	mapType: Titanium.Map.HYBRID_TYPE,
	region:{latitude:35.512902, longitude:-97.629424, latitudeDelta:0.0009, longitudeDelta:0.0009}, 
	animate:true,
	regionFit:true,
	userLocation:true,
...
if (!isAndroid) {
	mapview.addAnnotation(cantrell);
}
mapview.selectAnnotation(cantrell);
win.add(mapview);
...
cantrell.addEventListener('click', function(evt)
{
