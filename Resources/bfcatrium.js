...
if (!isAndroid) {
	bfcatriumParams.pincolor = Titanium.Map.ANNOTATION_PURPLE;
} else {
	bfcatriumParams.pinImage = "../images/map-pin.png";
}
var bfcatrium = Titanium.Map.createAnnotation(bfcatriumParams);

//
// PRE-DEFINED REGIONS
//
var regionbfcatrium = {latitude:35.51335,longitude:-97.63136,animate:true,latitudeDelta:0.04, longitudeDelta:0.04};
...
var presetAnnotations = [bfcatrium];
var mapview = Titanium.Map.createView({
	mapType: Titanium.Map.HYBRID_TYPE,
	region:{latitude:35.51335, longitude:-97.63136, latitudeDelta:0.0009, longitudeDelta:0.0009}, 
	animate:true,
	regionFit:true,
	userLocation:true,
...
if (!isAndroid) {
	mapview.addAnnotation(bfcatrium);
}
mapview.selectAnnotation(bfcatrium);
win.add(mapview);
...
bfcatrium.addEventListener('click', function(evt)
{
