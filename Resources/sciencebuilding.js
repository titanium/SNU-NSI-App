...
var sciencebuildingParams = {
		latitude:35.513728, 
		longitude:-97.628170,
		title:"SNU",
		subtitle:'W. Don Beaver Science Building',
		animate:true,
...
if (!isAndroid) {
	sciencebuildingParams.pincolor = Titanium.Map.ANNOTATION_PURPLE;
} else {
	sciencebuildingParams.pinImage = "../images/map-pin.png";
}
var sciencebuilding = Titanium.Map.createAnnotation(sciencebuildingParams);

//
// PRE-DEFINED REGIONS
//
var regionSciencebuilding = {latitude:35.513728,longitude:-97.628170,animate:true,latitudeDelta:0.04, longitudeDelta:0.04};
...
var presetAnnotations = [sciencebuilding];
var mapview = Titanium.Map.createView({
	mapType: Titanium.Map.HYBRID_TYPE,
	region:{latitude:35.513728, longitude:-97.628170, latitudeDelta:0.0009, longitudeDelta:0.0009}, 
	animate:true,
	regionFit:true,
	userLocation:true,
...
if (!isAndroid) {
	mapview.addAnnotation(sciencebuilding);
}
mapview.selectAnnotation(sciencebuilding);
win.add(mapview);
...
sciencebuilding.addEventListener('click', function(evt)
{
