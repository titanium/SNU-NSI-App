...
var hillsclassroomParams = {
		latitude:35.512369, 
		longitude:-97.627138,
		title:"SNU",
		subtitle:'A.M. Hills Classroom',
		animate:true,
...
if (!isAndroid) {
	hillsclassroomParams.pincolor = Titanium.Map.ANNOTATION_PURPLE;
} else {
	hillsclassroomParams.pinImage = "../images/map-pin.png";
}
var hillsclassroom = Titanium.Map.createAnnotation(hillsclassroomParams);

//
// PRE-DEFINED REGIONS
//
var regionHillsclassroom = {latitude:35.512369,longitude:-97.627138,animate:true,latitudeDelta:0.04, longitudeDelta:0.04};
...
var presetAnnotations = [hillsclassroom];
var mapview = Titanium.Map.createView({
	mapType: Titanium.Map.HYBRID_TYPE,
	region:{latitude:35.512369, longitude:-97.627138, latitudeDelta:0.0009, longitudeDelta:0.0009}, 
	animate:true,
	regionFit:true,
	userLocation:true,
...
if (!isAndroid) {
	mapview.addAnnotation(hillsclassroom);
}
mapview.selectAnnotation(hillsclassroom);
win.add(mapview);
...
hillsclassroom.addEventListener('click', function(evt)
{
