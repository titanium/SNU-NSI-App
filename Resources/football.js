...
if (!isAndroid) {
	footballParams.pincolor = Titanium.Map.ANNOTATION_PURPLE;
} else {
	footballParams.pinImage = "../images/map-pin.png";
}
var football = Titanium.Map.createAnnotation(footballParams);

//
// PRE-DEFINED REGIONS
//
var regionFootball = {latitude:35.521155,longitude:-97.661837,animate:true,latitudeDelta:0.04, longitudeDelta:0.04};
...
var presetAnnotations = [football];
var mapview = Titanium.Map.createView({
	mapType: Titanium.Map.HYBRID_TYPE,
	region:{latitude:35.521155, longitude:-97.661837, latitudeDelta:0.0009, longitudeDelta:0.0009}, 
	animate:true,
	regionFit:true,
	userLocation:true,
...
if (!isAndroid) {
	mapview.addAnnotation(football);
}
mapview.selectAnnotation(football);
win.add(mapview);
...
football.addEventListener('click', function(evt)
{
