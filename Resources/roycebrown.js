...
var roycebrownParams = {
		latitude:35.512737, 
		longitude:-97.628754,
		title:"SNU",
		subtitle:'Royce Brown',
		animate:true,
...
if (!isAndroid) {
	roycebrownParams.pincolor = Titanium.Map.ANNOTATION_PURPLE;
} else {
	roycebrownParams.pinImage = "../images/map-pin.png";
}
var roycebrown = Titanium.Map.createAnnotation(roycebrownParams);

//
// PRE-DEFINED REGIONS
//
var regionRoycebrown = {latitude:35.512737,longitude:-97.628754,animate:true,latitudeDelta:0.04, longitudeDelta:0.04};
...
var presetAnnotations = [roycebrown];
var mapview = Titanium.Map.createView({
	mapType: Titanium.Map.HYBRID_TYPE,
	region:{latitude:35.512737, longitude:-97.628754, latitudeDelta:0.0009, longitudeDelta:0.0009},
	animate:true,
	regionFit:true,
	userLocation:true,
...
if (!isAndroid) {
	mapview.addAnnotation(roycebrown);
}
mapview.selectAnnotation(roycebrown);
win.add(mapview);
...
roycebrown.addEventListener('click', function(evt)
{
