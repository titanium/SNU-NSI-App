...
if (!isAndroid) {
	snowbargerParams.pincolor = Titanium.Map.ANNOTATION_PURPLE;
} else {
	snowbargerParams.pinImage = "../images/map-pin.png";
}
var snowbarger = Titanium.Map.createAnnotation(snowbargerParams);

//
// PRE-DEFINED REGIONS
//
var regionSnowbarger = {latitude:35.514793,longitude:-97.629589,animate:true,latitudeDelta:0.04, longitudeDelta:0.04};
...
var presetAnnotations = [snowbarger];
var mapview = Titanium.Map.createView({
	mapType: Titanium.Map.HYBRID_TYPE,
	region:{latitude:35.514793, longitude:-97.629589, latitudeDelta:0.0009, longitudeDelta:0.0009}, 
	animate:true,
	regionFit:true,
	userLocation:true,
...
if (!isAndroid) {
	mapview.addAnnotation(snowbarger);
}
mapview.selectAnnotation(snowbarger);
win.add(mapview);
...
snowbarger.addEventListener('click', function(evt)
{
