...
if (!isAndroid) {
	penielParams.pincolor = Titanium.Map.ANNOTATION_PURPLE;
} else {
	penielParams.pinImage = "../images/map-pin.png";
}
var peniel = Titanium.Map.createAnnotation(penielParams);

//
// PRE-DEFINED REGIONS
//
var regionPeniel = {latitude:35.511694,longitude:-97.627671,animate:true,latitudeDelta:0.04, longitudeDelta:0.04};
...
var presetAnnotations = [peniel];
var mapview = Titanium.Map.createView({
	mapType: Titanium.Map.HYBRID_TYPE,
	region:{latitude:35.511694, longitude:-97.627671, latitudeDelta:0.0009, longitudeDelta:0.0009}, 
	animate:true,
	regionFit:true,
	userLocation:true,
...
if (!isAndroid) {
	mapview.addAnnotation(peniel);
}
mapview.selectAnnotation(peniel);
win.add(mapview);
...
peniel.addEventListener('click', function(evt)
{
