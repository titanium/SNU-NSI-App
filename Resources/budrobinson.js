...
var budrobinsonParams = {
		latitude:35.512369, 
		longitude:-97.627138,
		title:"SNU",
		subtitle:'Bud Robinson Room',
		animate:true,
...
if (!isAndroid) {
	budrobinsonParams.pincolor = Titanium.Map.ANNOTATION_PURPLE;
} else {
	budrobinsonParams.pinImage = "../images/map-pin.png";
}
var budrobinson = Titanium.Map.createAnnotation(budrobinsonParams);

//
// PRE-DEFINED REGIONS
//
var regionBudrobinson = {latitude:35.512369,longitude:-97.627138,animate:true,latitudeDelta:0.04, longitudeDelta:0.04};
...
var presetAnnotations = [budrobinson];
...
if (!isAndroid) {
	mapview.addAnnotation(budrobinson);
}
mapview.selectAnnotation(budrobinson);
win.add(mapview);
...
budrobinson.addEventListener('click', function(evt)
{
